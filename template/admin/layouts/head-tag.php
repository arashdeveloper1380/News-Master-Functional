...
<nav class="navbar  navbar-light bg-gradiant-green-blue nav-shadow">
    ...
    <a class="navbar-brand" href="<?= url('/') ?>"> <?php echo $setting['title'] ?></a>
    <span class="">
        <?php
        ...
        ?>
                ...
                <a class="text-decoration-none px-3 text-dark" href="<?= url('comment') ?>"><i class="fas fa-comments"></i>
...
<div class="container-fluid">
    <div class="row">
        <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
            ...
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('category') ?>"><i class="fas fa-clipboard-list"></i> Category</a>
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('article') ?>"><i class="fas fa-newspaper"></i> Article</a>
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('comment') ?>"><i class="fas fa-comments"></i> Comment</a>
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('menu') ?>"><i class="fas fa-bars"></i> Menus</a>
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('user') ?>"><i class="fas fa-users"></i> User</a>
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('web-setting') ?>"><i class="fas fa-tools"></i> Web Setting</a>
        </nav>
